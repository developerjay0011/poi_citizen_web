...
export const fetchCitizenFollowingList = async (citizenid: any, token: any) => {
  try {
    const res = await fetch(
      // `${process.env.NEXT_PUBLIC_BASE_URL}/api/Citizen/CitizenFollowingList/${citizenid}`,
      `${process.env.NEXT_PUBLIC_BASE_URL}/api/Leader/FollowingList/${citizenid}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
